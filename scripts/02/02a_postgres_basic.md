...
[PostgresBasicPermissions](https://github.com/Woberegger/DatabaseSecurity/blob/main/scripts/02/02b_postgres_basic_permissions.sql)
...
[PostgresTableInheritance](https://github.com/Woberegger/DatabaseSecurity/blob/main/scripts/02/02c_postgres_table_inheritance.sql)
```bash
sudo -s
